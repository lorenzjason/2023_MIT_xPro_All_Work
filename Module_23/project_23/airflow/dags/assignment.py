...
def catalog():
    ...
    urllist = ['http://student.mit.edu/catalog/m1a.html',
...
def clean():
   ...
   def store_json(data,file):
        with open(file,'w', encoding='utf-8') as cleandatafile:
            json.dump(data, cleandatafile, ensure_ascii=False, indent=4)
...
def count_words():
     ...
     def store_json(data,file):
        with open(file,'w', encoding='utf-8') as countdatafile:
            json.dump(data, countdatafile, ensure_ascii=False, indent=4)
