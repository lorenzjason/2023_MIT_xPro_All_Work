...
def combine():
    ...
    with open('combo.txt') as outfile:
...
def clean():
   ...
   def store_json(data,file):
        cleandatafile = open(file)
        cleandatafile.write(data)
        cleandatafile.close()

        print('wrote file: ' + cleandatafile)
...
def count_words():
     ...
     def store_json(data,file):
        countdatafile = open(file)
        countdatafile.write(data)
        countdatafile.close()

        print('wrote file: ' + countdatafile)
