...
books = [
    ...
    },
    {
        ...
        "country": "USA",
        "language": "English",
        "title": "Chemistry by OpenStax",
        "year": 2015,
    },
    {
    "id": 5,
        "author": "Microbiology An Introduction",
        "country": "USA",
        "language": "English",
        "title": "Gerard Tortora",
        "year": 2018,
    }
]
...
users = [
    ...
    {"username": "Mitch", "password": "Mitch", "role": "admin"},
    {"username": "Eric", "password": "Eric", "role": "reader"}
]
...
def login():
    if request.method == "POST":
        ...
        if validUser != None:
            ...
            claims = {"roles": validUser["roles"]}
            access_token = create_access_token(username, additional_claims =claims)
